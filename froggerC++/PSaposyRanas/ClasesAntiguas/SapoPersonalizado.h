...
protected:
	...
	SapoMovimiento* sapoMovimiento;
public:
	//static int getNumeroActores();
	SapoPersonalizado() {};
	SapoPersonalizado(vector<string> _avatar, int _x, int _y, int _dx, int _dy, int _limiteSuperior, int _limiteInferior, int _limiteIzquierda, int _limiteDerecha);
